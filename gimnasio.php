...
class Clase{
    ...
    public function imprimirListado(){
         ...
         echo "<tr><th colspan='5'>Alumnos inscriptos:</th></tr>";
         echo "<tr><th>DNI</th><th>Nombre</th><th>Correo</th><th>Celular</th><th>Fecha nacimiento</th></tr>";
         foreach($this->aAlumnos as $alumno){
            echo "<tr><td>" . number_format($alumno->dni, 0, ",", ".") . "</td><td>" . $alumno->nombre . "</td><td>" . $alumno->correo ."</td><td>" . $alumno->celular . "</td><td>" . $alumno->fechaNac . "</td></tr>";
        }
        echo "</table>";
    }
...
$alumno1 = new Alumno("40787657", "Dante Montera", "dante@hotmail.com", "1145632457", "1997-08-28");
$alumno1->setFichaMedica(90, 178, true);
$alumno1->presentismo = 78;

$alumno2 = new Alumno("46766547", "Dario Turchi", "dario@gmail.com", "1123564487", "1986-11-21");
$alumno2->setFichaMedica(73, 168, false);
$alumno2->presentismo = 68;

$alumno3 = new Alumno("39765454", "Facundo Fagnano", "facundo@gmail.com", "1124597536", "1993-02-06");
$alumno3->setFichaMedica(90, 187, true);
$alumno3->presentismo = 88;

$alumno4 = new Alumno("41687536", "Gaston Aguilar", "gaston@hotmail.com", "1127305489", "1999-11-02");
