    ...
    <main class="container">
        <div class="row ">
            ...
            <table class="table table-hover border">
                ...
                <tbody>
                    <?php 
                    foreach($aPacientes as $paciente){  /* $paciente abarca todos los datos de un paciente. Con Foreach utomaticamente imprime los 4 pacientes sin necesidad de poner un contador (++). Si quiero imprimir un dato agrego ["dni"] por ejemplo.*/
